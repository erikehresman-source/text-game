...
// Use absolute path for GitHub Pages hosting
const gamePath = window.location.origin + '/text-game/docs/games/demo.json';

// 🧭 Debug: show the path being fetched
console.log("📁 Attempting to fetch:", gamePath);
document.body.insertAdjacentHTML(
  'beforeend',
  `<p style="color:lime;font-family:monospace;">Attempting: ${gamePath}</p>`
);
